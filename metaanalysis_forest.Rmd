...
results_table <- combined_results %>% 
  ...
  select(Analysis, `Estimate `, Weight.random, p.value, Predict.CI, I2, I2.CI, H, H.CI, tau2, tau2.CI)
...
min_est = min(readmit_n_results$CI.Low, na.rm = TRUE)-1
max_est = max(readmit_n_results$CI.High, na.rm = TRUE)+1
