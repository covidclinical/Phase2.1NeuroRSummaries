...
# max_est = max(length_stay_results$CI.Low, na.rm = TRUE)+2)
...
forester(left_side_data = length_stay_results[1],
         ...
         xlim = c(-2, 12),
         xbreaks = c(0, 2, 4, 6, 8, 10, 12),
         point_sizes = sizes,
         point_shapes = shapes,
         file_path = here::here(paste0("figs/length_of_stay", meta_results[["n_stay_reg_elix"]][["data"]][["term"]][[1]],".png")))
```
...
forester(left_side_data = readmit_results[1],
         ...
         point_sizes = sizes,
         point_shapes = shapes,
         file_path = here::here(paste0("figs/readmission", meta_results[["n_stay_reg_elix"]][["data"]][["term"]][[1]],".png")))
```
...
forester(left_side_data = severe_results[1],
         ...
         point_sizes = sizes,
         point_shapes = shapes,
         file_path = here::here(paste0("figs/severe", meta_results[["n_stay_reg_elix"]][["data"]][["term"]][[1]],".png")))
```
...
forester(left_side_data = death_results[1],
         ...
         point_sizes = sizes,
         point_shapes = shapes,
         file_path = here::here(paste0("figs/death", meta_results[["n_stay_reg_elix"]][["data"]][["term"]][[1]],".png")))
```
...
forester(left_side_data = severe_time_results[1],
         ...
         arrow_labels = c("Decreased Days", "Increased Days"),
         xlim = c(-18, 6),
         xbreaks = c(-18, -12, -6, 0, 6),
         point_sizes = sizes,
         point_shapes = shapes,
         file_path = here::here(paste0("figs/time_to_severe", meta_results[["n_stay_reg_elix"]][["data"]][["term"]][[1]],".png")))
```
...
forester(left_side_data = death_time_results[1],
         ...
         arrow_labels = c("Decreased Days", "Increased Days"),
         xlim = c(-18,18),
         xbreaks = c(-18, -12, -6, 0, 6, 12, 18),
         point_sizes = sizes,
         point_shapes = shapes,
         file_path = here::here(paste0("figs/time_to_death", meta_results[["n_stay_reg_elix"]][["data"]][["term"]][[1]],".png")))
```
...
forester(left_side_data = readmit_time_results[1],
         ...
         point_sizes = sizes,
         point_shapes = shapes,
         file_path = here::here(paste0("figs/admission_time", meta_results[["n_stay_reg_elix"]][["data"]][["term"]][[1]],".png")))
```
...
forester(left_side_data = readmit_n_results[1],
         ...
         point_sizes = sizes,
         point_shapes = shapes,
         file_path = here::here(paste0("figs/readmission_n", meta_results[["n_stay_reg_elix"]][["data"]][["term"]][[1]],".png")))
```
