...
```{r}
load("public-data/neuro_icds_10.rda")
load("public-data/neuro_icds_9.rda")

neuro_icds_10 <- neuro_icds_10 %>%
...
diag_counts <- colSums(Filter(is.numeric, diag_table_wide), na.rm = TRUE) %>% data.frame()
